# Inequality-adjusted Human Development Index vs. Human Development Index - Data package

This data package contains the data that powers the chart ["Inequality-adjusted Human Development Index vs. Human Development Index"](https://ourworldindata.org/grapher/inequality-adjusted-hdi-vs-human-development-index?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
...
#### Full citation
UNDP, Human Development Report (2025) – with minor processing by Our World in Data. “Inequality-adjusted HDI – UNDP” [dataset]. UNDP, Human Development Report, “Human Development Report” [original data].
