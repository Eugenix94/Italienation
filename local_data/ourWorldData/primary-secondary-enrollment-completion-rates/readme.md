# Primary, secondary and tertiary education enrolment and completion rates - Data package

This data package contains the data that powers the chart ["Primary, secondary and tertiary education enrolment and completion rates"](https://ourworldindata.org/grapher/primary-secondary-enrollment-completion-rates?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
...
#### Full citation
UNESCO Institute for Statistics (2025) – with minor processing by Our World in Data. “Gross enrolment ratio in primary education” [dataset]. UNESCO Institute for Statistics, “UNESCO Institute for Statistics (UIS) - Education” [original data].
...
#### Full citation
UNESCO Institute for Statistics (2025) – with minor processing by Our World in Data. “Gross enrolment ratio in tertiary education” [dataset]. UNESCO Institute for Statistics, “UNESCO Institute for Statistics (UIS) - Education” [original data].
Source: UNESCO Institute for Statistics (2025) – with minor processing by Our World In Data
