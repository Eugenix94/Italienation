# Tripartite Tracking vs. International Comprehensive Systems: A Comparative Synthesis (2026-2027)
...
| **United Kingdom** | Comprehensive GCSE (11–16) $ightarrow$ A-Levels / T-Levels (16–18) | **16** | **100% State-Funded via School Budget** (Zero out-of-pocket textbook fees for parents). | **14.2%** | Salaried Apprenticeships (£5.28–£10.42/hr for T-Levels) | **Yes** (State schools provide core textbooks & digital materials free). |
| **Finland** | Unified Basic (*Peruskoulu* 7–16) $ightarrow$ *Lukio* / *Ammatillinen* | **16** | **100% Free** (2021 Extension Act: Free textbooks, laptops, transport up to age 18). | **8.1%** | Paid Vocational Traineeships + Employer Co-Design | **Yes** (Universal free learning materials & digital devices up to age 18). |
...
| **France** | *Collège Unique* (11–15) $ightarrow$ *Lycée Général/Technologique/Pro* | **15** | **100% Free Regionally Provided** (Regional passes/loans fund 100% of Lycée textbooks). | **22.8%** | Salaried Apprenticeship (*Apprentissage*: % of SMIC minimum wage) | **Yes** (Regional councils fund free digital & physical textbook packs). |
